...
<body>	
            ...
            <div class="modal-content">
                ...
                <form action="${contextPath}/login.me" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <label for='saveId'>아이디 저장</label> <input type="checkbox" name="saveId" id="saveId"> <br>
    ...
    <%
    	...
    	//쿠키 배열 추출한 뒤 원하는 쿠키 찾기 
    	//원하는 쿠키에 담긴 값 추출해보기 
    	String str = "";
    	for(Cookie c : cookies){
    		if(c.getName().equals("userId")){//원하는 쿠키찾음 .getName() : 쿠키의 이름 반환메소드
    			str = c.getValue(); //해당 쿠키의 값 추출 .getValue() : 쿠키의 값 반환메소드
    			break;
    		}
    	}
    %>
    ...
    <script>
    	$(function(){
    		...
    		if(saveId!=""){//있으면 
    			$("#userId").val(saveId); //아이디 입력상자에 저장된 아이디값 넣기
    			$("#saveId").attr("checked",true); //체크박스 체크하기
    		}
